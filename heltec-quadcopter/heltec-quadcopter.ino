...
#define HW_BOARD_NAME "Heltec Lora v3" //REQUIRED: Give your board a name - without a name the default pinout is loaded!!!
...
//LED:
#define HW_PIN_LED        35
#define HW_LED_ON          1 //0:low is on, 1:high is on

//IMU SPI:
//#define HW_PIN_SPI_MISO   38
//#define HW_PIN_SPI_MOSI   39
//#define HW_PIN_SPI_SCLK   34
//#define HW_PIN_IMU_CS     33
#define HW_PIN_IMU_EXTI   40 //REQUIRED: IMU external interrupt pin (required for SPI and I2C sensors)

//I2C for BARO, MAG, BAT sensors (and for IMU if not using SPI IMU)
//#define HW_PIN_I2C_SDA    pp
//#define HW_PIN_I2C_SCL    pp

#define HW_PIN_I2C_SDA 33
#define HW_PIN_I2C_SCL 34

//Motor/Servo Outputs:
#define HW_OUT_COUNT      4 //number of outputs
#define HW_PIN_OUT_LIST   {41,42,45,46} //list of output pins, enter exactly HW_OUT_COUNT pins.
...
//--- IMU SENSOR
#define IMU_USE  IMU_USE_I2C_MPU9250 // IMU_USE_SPI_MPU6500, IMU_USE_SPI_MPU9250,IMU_USE_SPI_MPU6000, IMU_USE_SPI_BMI270, IMU_USE_I2C_MPU9250, IMU_USE_I2C_MPU9150, IMU_USE_I2C_MPU6500, IMU_USE_I2C_MPU6050, IMU_USE_I2C_MPU6000
